package com.vershininds.mixture.sample.presentation.common.dbadapter;
...
import com.vershininds.mixture.sample.presentation.common.dbadapter.adapter.ColorDividerItemDecoration;
import com.vershininds.mixture.sample.presentation.common.dbadapter.adapter.DividerItemDecoration;
import com.vershininds.mixture.sample.presentation.common.dbadapter.adapter.LoadMoreScrollListener;
import com.vershininds.mixture.sample.presentation.common.dbadapter.adapter.TwoWayLoadingScrollListener;
...
public class ListConfig {
    ...
    public static class Builder {
         ...
         *                         simple: {@link LoadMoreScrollListener}
         *                         or {@link TwoWayLoadingScrollListener}
         * @return the builder
         */
        ...
        public ListConfig build(Context context) {
            ...
            if (mDefaultDividerSize >= 0) {
                if (mDefaultDividerSize == 0) mDefaultDividerSize = 4/*context.getResources()
